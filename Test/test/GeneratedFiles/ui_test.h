...
public:
    ...
    void setupUi(QMainWindow *testClass)
    {
        ...
        testClass->resize(682, 550);
        centralWidget = new QWidget(testClass);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        openGLWidget = new GLWidget(centralWidget);
        openGLWidget->setObjectName(QStringLiteral("openGLWidget"));
        openGLWidget->setGeometry(QRect(0, 0, 671, 501));
        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(510, 50, 75, 23));
    ...
    void retranslateUi(QMainWindow *testClass)
    {
        ...
        pushButton->setText(QApplication::translate("testClass", "Ok", 0));
    } // retranslateUi
